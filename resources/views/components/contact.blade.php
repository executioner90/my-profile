        ...
        <div class="w-1/3">
            <form id="form" novalidate class="flex flex-col">
                <div class="mb-1">
                    ...
                    <p id="nameError" class="hidden mb-2 text-red-500 text-sm italic">Please enter your name (max 50 chars)</p>
                </div>

                <div class="mb-1"   >
                    <input id="email" placeholder="Email address" type="email" name="email" class="w-full pt-1 pl-1" required>
                    <p id="emailError" class="hidden mb-2 text-red-500 text-sm italic">Please enter a valid email address</p>
                </div>

                <div class="mb-1"   >
                    <input id="subject" placeholder="Subject" type="text" name="subject" class="w-full pt-1 pl-1" required>
                    <p id="subjectError" class="hidden mb-2 text-red-500 text-sm italic">Please enter a subject (max 50 chars)</p>
                </div>

                <div>
                    <textarea id="message" placeholder="Your message/question..." name="message" rows="5" class="w-full pt-1 pl-1" required></textarea>
                    <p id="messageError" class="hidden text-red-500 text-sm italic">Please enter your message/question (min 10 chars)</p>
                </div>
