...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="about" class="min-h-screen w-screen about">
            <div class="grid grid-cols-4 gap-20 mt-1.5 mb-2">
            ...
            <div class="grid grid-cols-4 gap-20 my-3">
                <div class="about-me-card py-8 px-3 flex items-center justify-center text-center rounded-3xl">
                    Fulltime study and working simultaneously
                </div>

                <div class="col-span-2">
                    <div class="grid grid-cols-2 m-3">
                        <div class="about-me-card py-8 px-6 flex items-center justify-center text-start rounded-3xl mr-2">
                            Flexibility and more understanding about individuality
                        </div>
                        <div class="about-me-card py-8 px-6 flex items-center justify-center rounded-3xl">
            ...
            <div class="grid grid-cols-4 gap-20 my-3">
                <div class="about-me-card py-1 px-6 flex items-center justify-center text-center rounded-3xl">
                    High school certificates (English, maths, physics)
                </div>

                <div class="col-span-2">
                    <div class="grid grid-cols-3 m-3">
                        <div class="about-me-card py-1 px-3 flex items-center justify-center rounded-3xl">
                            Never give up and be patience.
                        </div>

                        <div class="px-3 flex items-center justify-center text-center rounded-3xl">
                            <div class="w-4/6">
                ...
                <div class="about-me-card py-1 px-3 flex items-center justify-center text-center rounded-3xl">
            ...
            <div class="grid grid-cols-4 gap-20 my-3">
                ...
                <div class="col-span-2">
                    <div class="grid grid-cols-2 rounded-3xl m-3">
                        <div class="about-me-card py-3 px-6 flex items-center justify-center rounded-3xl mr-2">
                            Practicality, analytical skills and teamwork
                        </div>

                        <div class="about-me-card py-3 px-6 flex items-center justify-center text-start rounded-3xl">
